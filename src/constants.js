...
export const LIVE_STREAMING_DOCS_URL = `${process.env.REACT_APP_DOCS_BASE_URL}/live-streaming-sdk/interactive-live-streaming`;
export const WEBSOCKET_SERVICE_URL = `${process.env.REACT_APP_WEBSOCKET_SERVICE_HOST}/api/v1/messaging/websocket`;
...
export const STREAMING_URL_KEYS = [
  ...
  export const STREAMING_TYPES = [
    {value: 'normal_latency', label: 'Normal Latency'},
    {value: 'is_low_latency', label: 'Low Latency'},
    {value: 'multi_bitrate', label: 'Multi Bitrate'},
    {value: 'is_vod', label: 'Video On Demand'}
  ]
