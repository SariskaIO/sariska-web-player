  ...
  return (
    ...
    <div className="chatContainer">
            <div style={{maxHeight: "calc(100vh - 200px)", minHeight: "calc(100vh - 200px)", display: chat || online ? 'block' : 'none'}} id="chat-container" className="max-h-screen flex flex-col lg:flex-row lg:min-h-screen ">
                <div style={{display: chat ? 'block' : 'none', width: '90%', height: "calc(100vh - 250px)", position: 'relative', margin: 'auto'}}>
                    <div style={{height: '100%', border: `1px solid ${color.whiteLight}`, borderRadius: '10px'}} className="flex flex-col lg:flex-grow relative ml-4 mr-4 mb-4 border-2 radius rounded-md">
                    ...
                    <footer id="footer" style={{position: "absolute", bottom: "-80px", width:"100%", paddingLeft: 0}} className="bg-slate-800 p-2 w-full h-[3rem] bottom-0 flex justify-center sticky">
                        <div className="w-full flex flex-row items-center text-gray-700 focus:outline-none font-normal pl-4">
                            <div>
                                ...
                                <div id="dummy"></div>
                                <div style={{display: 'flex', width: '100%', borderRadius: '5px', background: color.secondary, border: `1px solid ${color.white}`}} className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                                    <div style={{position: "absolute", top: "-11px", background: "#a5c3f0", alignItems: 'center', paddingLeft: '15px', color: '#3b9090', width: "81%",display: "none", justifyContent: "space-between"}} id="attachedDocumentContainer" className="flex items-center mx-4">
